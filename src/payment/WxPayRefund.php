...
class WxPayRefund extends WxPayDataBase
{
     ...
     * @param string $value
     **/
    public function SetDevice_info(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetNonce_str(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetTransaction_id(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetOut_refund_no(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetTotal_fee(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetRefund_fee(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetRefund_fee_type(string $value)
    {
     ...
     * @param string $value
     **/
    public function SetOp_user_id(string $value)
    {
